...
import { BOARD_UPDATE_PATH, COUNT_BY_PAGE, COUNT_BY_PAGE_COMMENT, MAIN_PATH, USER_PAGE_PATH } from 'src/constants';
...
export default function BoardDetail() {
        ...
        <div className='board-detail-top'>
          ...
          <div className='board-detail-meta-container'>
            <div className='board-detail-meta-left'>
              ...
              <div className='board-detail-writer-date'>{'\|'}</div>
              <div className='board-detail-writer-date'>{ dateFormat(board?.writeDatetime as string) }</div>
            </div>
  ...
  useEffect(() => {
    changeSection(commentList.length, COUNT_BY_PAGE);
  },[currentSection]);
